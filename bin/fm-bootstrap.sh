...
#          secondmate_handoff_resume, x_mode_setup, logbook_notify_setup,
...
#          X-mode artifacts, the logbook notify command, project clones, or
#          repair instructions.
...
#   config/x-mode.env      - declares FM_CHECK_INTERVAL=30; bin/fm-cadence-lib.sh
#                            applies it wherever a watcher is launched, so only
#                            an X instance polls at the 30s cadence
...
# Applied automatically whenever this home launches a watcher process, so
