...
#          logbook_setup, fleet_sync) while still printing every read-only
#          detect line above; the TANGLE line switches to advisory-only
...
# shellcheck source=bin/fm-logbook-lib.sh disable=SC1091
