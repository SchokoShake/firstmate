#!/usr/bin/env bash
# Merge a task's PR after recording it through bin/fm-pr-check.sh, whose header
# owns the recorded fields, so teardown can verify landed work after squash merges.
